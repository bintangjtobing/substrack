...
function chartjsLineChartForcast(
    selector,
    label = "",
    startGradient = "#05234912",
    endGradient = "#05234902",
    bColor = "#20C997",
                    ...
                    datasets: [
                        {
                            ...
                            // backgroundColor: bgColor,
                            borderColor: bColor,
                            pointHoverBackgroundColor: "#052349",
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        data: dataG,
                        backgroundColor: "#05234980",
                        hoverBackgroundColor: "#052349",
                        label: "Gained",
                    },
                    // {
                    //   data: dataL,
...
chartJsBarChartThree("mychart8", "#05234920", "#052349", "Order");
...
chartJsBarChartFour("mychart13", "#05234920", "#052349", "New Deals");
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        data: data,
                        backgroundColor: ["#20C997", "#052349", "#FA8B0C"],
                        total: "9,283",
                    },
                ],
            },
